...
public class ScreenToWorldDemo : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        var currentScreenPositionWithDepth = currentScreenPos;
        currentScreenPositionWithDepth.z = distanceFromCamera;

        currentWorldPos = cam.ScreenToWorldPoint(currentScreenPositionWithDepth);
