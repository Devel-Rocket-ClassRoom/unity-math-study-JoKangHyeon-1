...
public class Assignment_SmoothCamera : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        Vector3 targetPosition = target.position + offset.normalized * currentZoomDistance + Vector3.up * offset.y;
        positionVelocity = Vector3.SmoothDamp(transform.position, targetPosition, ref currentSmoothVelocity, positionSmoothTime);
        transform.position = positionVelocity;
