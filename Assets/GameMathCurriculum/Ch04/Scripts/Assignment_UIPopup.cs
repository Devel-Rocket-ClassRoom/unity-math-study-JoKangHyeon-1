...
public class Assignment_UIPopup : MonoBehaviour
{
    ...
    private void UpdateAnimation()
    {
        ...
        {
            canvasGroup.alpha = EaseIn(t);
            canvasGroup.transform.localScale = new Vector3(EaseIn(t), EaseIn(t), EaseIn(t));
        ...
        else if (currentState == PopupState.Hiding)
        {
            ...
            canvasGroup.transform.localScale = new Vector3(EaseOut(t), EaseOut(t), EaseOut(t));
